    ...
    if option == elements[0]:
        ...
        if click_1:
            ...
            st.info(f'Ввводим десятипроцентный раствор\n\n'
                    ...
                    f'(не более $10$ мл), за $1-2$ введения')
        ...
        Вводим 10% раствор \n
        $0.5$ мл/год/сут (кальция хлорид) - $1$ мл/год/сут (кальция глюконат)\n 
        ...
        weight = st.number_input(label='Введите вес', min_value=1., step=0.1)
        ...
        if click_2:
            st.info(f'Ввводим \n\n'
                    f'7.5% раствор: ${min_7:.2f}-{max_7:.2f}$ мл/сут\n\n'
                    f'4% раствор: ${min_4:.2f}-{max_4:.2f}$ мл/сут ')
        ...
        if click_3:
            ...
            {min_doze:.2f}-{max_doze:.2f} мл/сут (не более 20 мл за 2 раза)""")
